...
class ItemSeeder extends Seeder
{
    ...
    DB::table('items')->insert([
            'name' => 'エアマックス 95',
            'description' => '1995年のランニングマックスモデルの復刻版。時代を巻た名モデルAIR MAX95。当時は斬新でハイテクなルックスがストリートのフッションーンを席巻しました。',
            'price' => 25000,
            'seller' => 'Taro',
        ...
        $param = [
            [
                'name' => 'フットスケープ',
                'description' => '横にシューレースがある斬新なモデル。大切にしいだける方にお譲りします。',
                'price' => 18000,
                'seller' => 'Jiro',
            ...
            [
                'name' => 'ポンプフューリー',
                'description' => 'ポンプを押すと、空気によってパイプが膨らみ足型フィットします。',
                'price' => 18000,
                'seller' => 'Teru',
